...
survey1_id=$(curl -sf -XPOST ${API_URL}/organizations/${organization_id}/surveys -u ${USERNAME}:${PASSWORD} -H 'Content-Type: application/json' -d '{"survey_title":"Spring Fest 2023", "start_date_time":"2023-03-17T00:00:00.000+09:00", "end_date_time":"2024-03-17T00:00:00.000+09:00"}' | jq -r .survey_id)
