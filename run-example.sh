...
# 選択回答作成
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo1\", \"choices\": [{\"question_choice_id\": \"${question1_choice1_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo2\", \"choices\": [{\"question_choice_id\": \"${question1_choice1_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo3\", \"choices\": [{\"question_choice_id\": \"${question1_choice1_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo4\", \"choices\": [{\"question_choice_id\": \"${question1_choice1_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo5\", \"choices\": [{\"question_choice_id\": \"${question1_choice2_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question1_id}\", \"respondent_id\": \"demo6\", \"choices\": [{\"question_choice_id\": \"${question1_choice2_id}\"}]}"

curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question2_id}\", \"respondent_id\": \"demo1\", \"answer_text\": \"具体的なデータがあってわかりやすい\"}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question2_id}\", \"respondent_id\": \"demo2\", \"answer_text\": \"ER図がわかりやすい\"}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question2_id}\", \"respondent_id\": \"demo2\", \"answer_text\": \"ここまで複雑なモデルが必要なの?\"}"

curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question3_id}\", \"respondent_id\": \"demo1\", \"choices\": [{\"question_choice_id\": \"${question3_choice1_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question3_id}\", \"respondent_id\": \"demo2\", \"choices\": [{\"question_choice_id\": \"${question3_choice1_id}\"}, {\"question_choice_id\": \"${question3_choice2_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question3_id}\", \"respondent_id\": \"demo3\", \"choices\": [{\"question_choice_id\": \"${question3_choice2_id}\"}, {\"question_choice_id\": \"${question3_choice3_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question3_id}\", \"respondent_id\": \"demo4\", \"choices\": [{\"question_choice_id\": \"${question3_choice4_id}\"}]}"
curl -s -XPOST ${API_URL}/surveys/${survey1_id}/answers -H 'Content-Type: application/json' -u ${USERNAME}:${PASSWORD} -d "{\"question_id\": \"${question3_id}\", \"respondent_id\": \"demo5\", \"choices\": [{\"question_choice_id\": \"${question3_choice4_id}\"}]}"
